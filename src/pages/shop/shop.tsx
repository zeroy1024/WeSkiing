import { Input, Text, View, Swiper, SwiperItem, Image } from '@tarojs/components';
import './shop.scss';
    ...
    <>
      <View className={'shop-search-bar'} style={{ paddingTop: (statusBarHeight * 2) + 'rpx' }}>
        <View className={'shop-search'}>
          ...
          <Input className={'shop-search-input'} placeholder={'请输入...'} />
        </View>
      </View>
      ...
      <View className={'shop-content'}>
        ...
        <View className={'shop-recommend'}>
          <View className={'shop-title'}>推荐</View>
